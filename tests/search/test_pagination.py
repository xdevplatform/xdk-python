...
"""
Auto-generated pagination tests for {"class_name": "Search", "display_name": "search", "import_name": "search", "original": ["search"], "property_name": "search"} client.
...
class TestSearchPagination:
    """Test pagination functionality for SearchClient."""
    ...
    def test_posts_recent_cursor_creation(self):
        """Test that posts_recent can be used with Cursor."""
        ...
        try:
            ...
            pytest.fail(f"Method posts_recent should support pagination")


    def test_posts_recent_cursor_pages(self):
        """Test pagination with pages() for posts_recent."""
    ...
    def test_posts_recent_cursor_items(self):
        """Test pagination with items() for posts_recent."""
        with patch.object(self.client, "session") as mock_session:
    ...
    def test_posts_recent_pagination_parameters(self):
        """Test that pagination parameters are handled correctly for posts_recent."""
        with patch.object(self.client, "session") as mock_session:
            mock_response = Mock()
            mock_response.status_code = 200
            mock_response.json.return_value = {
    ...
    def test_posts_all_cursor_creation(self):
        """Test that posts_all can be used with Cursor."""
        ...
        try:
            ...
            pytest.fail(f"Method posts_all should support pagination")


    def test_posts_all_cursor_pages(self):
        """Test pagination with pages() for posts_all."""
        with patch.object(self.client, "session") as mock_session:
            # Mock first page response
            first_page_response = Mock()
            first_page_response.status_code = 200
    ...
    def test_posts_all_cursor_items(self):
        """Test pagination with items() for posts_all."""
        with patch.object(self.client, "session") as mock_session:
            # Mock response with paginated data
            mock_response = Mock()
            mock_response.status_code = 200
    ...
    def test_posts_all_pagination_parameters(self):
        """Test that pagination parameters are handled correctly for posts_all."""
        with patch.object(self.client, "session") as mock_session:
            mock_response = Mock()
            mock_response.status_code = 200
            mock_response.json.return_value = {
