...
"""
Auto-generated contract tests for {"class_name": "Search", "display_name": "search", "import_name": "search", "original": ["search"], "property_name": "search"} client.

This module contains tests that validate the request/response contracts
of the {"class_name": "Search", "display_name": "search", "import_name": "search", "original": ["search"], "property_name": "search"} client against the OpenAPI specification.
...
class TestSearchContracts:
    """Test the API contracts of SearchClient."""
    ...
    def test_posts_recent_request_structure(self):
        """Test posts_recent request structure."""
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            # Call the method
            try:
                method = getattr(self.search_client, "posts_recent")
                ...
                if (
                    ...
                    pytest.fail(f"Contract test failed for posts_recent: {e}")


    def test_posts_recent_required_parameters(self):
        """Test that posts_recent handles parameters correctly."""
        method = getattr(self.search_client, "posts_recent")
    ...
    def test_posts_recent_response_structure(self):
        """Test posts_recent response structure validation."""
        with patch.object(self.client, "session") as mock_session:
    ...
    def test_news_request_structure(self):
        """Test news request structure."""
        # Mock the session to capture request details
        with patch.object(self.client, "session") as mock_session:
            mock_response = Mock()
            mock_response.status_code = 200
            ...
            # Call the method
            try:
                method = getattr(self.search_client, "news")
                # Check if this is a true streaming operation (has stream_config parameter)
                import types
                import inspect
                sig = inspect.signature(method)
                ...
                if (
                    ...
                    pytest.fail(f"Contract test failed for news: {e}")


    def test_news_required_parameters(self):
        """Test that news handles parameters correctly."""
        method = getattr(self.search_client, "news")
        # Test with missing required parameters - mock the request to avoid network calls
        with patch.object(self.client, "session") as mock_session:
            # Mock a 400 response (typical for missing required parameters)
    ...
    def test_news_response_structure(self):
        """Test news response structure validation."""
        with patch.object(self.client, "session") as mock_session:
            # Create mock response from the OpenAPI response schema (minimal valid payload)
            mock_response_data = json.loads(r"""{}""")
            mock_response = Mock()
    ...
    def test_posts_all_request_structure(self):
        """Test posts_all request structure."""
        # Mock the session to capture request details
        with patch.object(self.client, "session") as mock_session:
            mock_response = Mock()
            mock_response.status_code = 200
            ...
            # Call the method
            try:
                method = getattr(self.search_client, "posts_all")
                # Check if this is a true streaming operation (has stream_config parameter)
                import types
                import inspect
                sig = inspect.signature(method)
                ...
                if (
                    ...
                    pytest.fail(f"Contract test failed for posts_all: {e}")


    def test_posts_all_required_parameters(self):
        """Test that posts_all handles parameters correctly."""
        method = getattr(self.search_client, "posts_all")
        # Test with missing required parameters - mock the request to avoid network calls
        with patch.object(self.client, "session") as mock_session:
            # Mock a 400 response (typical for missing required parameters)
    ...
    def test_posts_all_response_structure(self):
        """Test posts_all response structure validation."""
        with patch.object(self.client, "session") as mock_session:
            # Create mock response from the OpenAPI response schema (minimal valid payload)
            mock_response_data = json.loads(r"""{}""")
            mock_response = Mock()
