...
"""
Auto-generated pagination tests for {"class_name": "Broadcasts", "display_name": "broadcasts", "import_name": "broadcasts", "original": ["broadcasts"], "property_name": "broadcasts"} client.
...
class TestBroadcastsPagination:
    """Test pagination functionality for BroadcastsClient."""
    ...
    def test_list_scheduled_cursor_creation(self):
        """Test that list_scheduled can be used with Cursor."""
        ...
        try:
            ...
            pytest.fail(f"Method list_scheduled should support pagination")


    def test_list_scheduled_cursor_pages(self):
        """Test pagination with pages() for list_scheduled."""
    ...
    def test_list_scheduled_cursor_items(self):
        """Test pagination with items() for list_scheduled."""
        with patch.object(self.client, "session") as mock_session:
    ...
    def test_list_scheduled_pagination_parameters(self):
        """Test that pagination parameters are handled correctly for list_scheduled."""
        with patch.object(self.client, "session") as mock_session:
            mock_response = Mock()
            mock_response.status_code = 200
            mock_response.json.return_value = {
