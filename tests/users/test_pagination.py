...
class TestUsersPagination:
    ...
    def test_get_affiliates_cursor_creation(self):
        """Test that get_affiliates can be used with Cursor."""
        ...
        try:
            ...
            pytest.fail(f"Method get_affiliates should support pagination")


    def test_get_affiliates_cursor_pages(self):
        """Test pagination with pages() for get_affiliates."""
        with patch.object(self.client, "session") as mock_session:
            # Mock first page response
            first_page_response = Mock()
            first_page_response.status_code = 200
    ...
    def test_get_affiliates_cursor_items(self):
        """Test pagination with items() for get_affiliates."""
        with patch.object(self.client, "session") as mock_session:
            # Mock response with paginated data
            mock_response = Mock()
            mock_response.status_code = 200
    ...
    def test_get_affiliates_pagination_parameters(self):
        """Test that pagination parameters are handled correctly for get_affiliates."""
        with patch.object(self.client, "session") as mock_session:
            mock_response = Mock()
            mock_response.status_code = 200
            mock_response.json.return_value = {
    ...
    def test_get_bookmarks_by_folder_id_cursor_creation(self):
        """Test that get_bookmarks_by_folder_id can be used with Cursor."""
        ...
        try:
            ...
            pytest.fail(f"Method get_bookmarks_by_folder_id should support pagination")


    def test_get_bookmarks_by_folder_id_cursor_pages(self):
        """Test pagination with pages() for get_bookmarks_by_folder_id."""
        with patch.object(self.client, "session") as mock_session:
            # Mock first page response
            first_page_response = Mock()
            first_page_response.status_code = 200
    ...
    def test_get_bookmarks_by_folder_id_cursor_items(self):
        """Test pagination with items() for get_bookmarks_by_folder_id."""
        with patch.object(self.client, "session") as mock_session:
            # Mock response with paginated data
            mock_response = Mock()
            mock_response.status_code = 200
    ...
    def test_get_bookmarks_by_folder_id_pagination_parameters(self):
        """Test that pagination parameters are handled correctly for get_bookmarks_by_folder_id."""
        with patch.object(self.client, "session") as mock_session:
            mock_response = Mock()
            mock_response.status_code = 200
            mock_response.json.return_value = {
