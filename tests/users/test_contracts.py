...
class TestUsersContracts:
    ...
    def test_repost_post_request_structure(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            required_kwargs = {}
            for field_name, field_info in RepostPostRequest.model_fields.items():
            ...
            kwargs["body"] = RepostPostRequest(**required_kwargs)
            # Call the method
            try:
    ...
    def test_follow_user_request_structure(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            # Create instance with required fields (using dummy values for testing)
            required_kwargs = {}
            for field_name, field_info in FollowUserRequest.model_fields.items():
                if field_info.is_required():
                    annotation = (
                        str(field_info.annotation) if field_info.annotation else "str"
                    )
                    if "int" in annotation.lower():
                        ...
                        required_kwargs[field_name] = "test_value"
            kwargs["body"] = FollowUserRequest(**required_kwargs)
            # Call the method
            try:
    ...
    def test_create_bookmark_request_structure(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            # Create instance with required fields (using dummy values for testing)
            required_kwargs = {}
            for field_name, field_info in CreateBookmarkRequest.model_fields.items():
                if field_info.is_required():
                    annotation = (
                        str(field_info.annotation) if field_info.annotation else "str"
                    )
                    if "int" in annotation.lower():
                        ...
                        required_kwargs[field_name] = "test_value"
            kwargs["body"] = CreateBookmarkRequest(**required_kwargs)
            # Call the method
            try:
    ...
    def test_pin_list_request_structure(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            # Create instance with required fields (using dummy values for testing)
            required_kwargs = {}
            for field_name, field_info in PinListRequest.model_fields.items():
                if field_info.is_required():
                    annotation = (
                        str(field_info.annotation) if field_info.annotation else "str"
                    )
                    if "int" in annotation.lower():
                        ...
                        required_kwargs[field_name] = "test_value"
            kwargs["body"] = PinListRequest(**required_kwargs)
            # Call the method
            try:
    ...
    def test_mute_user_request_structure(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            # Create instance with required fields (using dummy values for testing)
            required_kwargs = {}
            for field_name, field_info in MuteUserRequest.model_fields.items():
                if field_info.is_required():
                    annotation = (
                        str(field_info.annotation) if field_info.annotation else "str"
                    )
                    if "int" in annotation.lower():
                        ...
                        required_kwargs[field_name] = "test_value"
            kwargs["body"] = MuteUserRequest(**required_kwargs)
            # Call the method
            try:
    ...
    def test_like_post_request_structure(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            # Create instance with required fields (using dummy values for testing)
            required_kwargs = {}
            for field_name, field_info in LikePostRequest.model_fields.items():
                if field_info.is_required():
                    annotation = (
                        str(field_info.annotation) if field_info.annotation else "str"
                    )
                    if "int" in annotation.lower():
                        ...
                        required_kwargs[field_name] = "test_value"
            kwargs["body"] = LikePostRequest(**required_kwargs)
            # Call the method
            try:
    ...
    def test_follow_list_request_structure(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            # Create instance with required fields (using dummy values for testing)
            required_kwargs = {}
            for field_name, field_info in FollowListRequest.model_fields.items():
                if field_info.is_required():
                    annotation = (
                        str(field_info.annotation) if field_info.annotation else "str"
                    )
                    if "int" in annotation.lower():
                        ...
                        required_kwargs[field_name] = "test_value"
            kwargs["body"] = FollowListRequest(**required_kwargs)
            # Call the method
            try:
