...
"""
Auto-generated pagination tests for {"class_name": "Connections", "display_name": "connections", "import_name": "connections", "original": ["connections"], "property_name": "connections"} client.
...
class TestConnectionsPagination:
    """Test pagination functionality for ConnectionsClient."""
    ...
    def test_get_connection_history_cursor_creation(self):
        """Test that get_connection_history can be used with Cursor."""
        ...
        try:
            ...
            pytest.fail(f"Method get_connection_history should support pagination")


    def test_get_connection_history_cursor_pages(self):
        """Test pagination with pages() for get_connection_history."""
        with patch.object(self.client, "session") as mock_session:
            ...
            first_page_response.json.return_value = {
                "data": json.loads(
                    r"""[{"connected_at":"2021-01-01T00:00:00.000Z","endpoint_name":"test_value"}, {"connected_at":"2021-01-01T00:00:00.000Z","endpoint_name":"test_value"}]"""
                ),
                "meta": {
                    **json.loads(r"""{}"""),
            ...
            second_page_response.json.return_value = {
                "data": json.loads(
                    r"""[{"connected_at":"2021-01-01T00:00:00.000Z","endpoint_name":"test_value"}]"""
                ),
    ...
    def test_get_connection_history_cursor_items(self):
        """Test pagination with items() for get_connection_history."""
        with patch.object(self.client, "session") as mock_session:
            ...
            mock_response.json.return_value = {
                "data": json.loads(
                    r"""[{"connected_at":"2021-01-01T00:00:00.000Z","endpoint_name":"test_value"}, {"connected_at":"2021-01-01T00:00:00.000Z","endpoint_name":"test_value"}, {"connected_at":"2021-01-01T00:00:00.000Z","endpoint_name":"test_value"}]"""
                ),
    ...
    def test_get_connection_history_pagination_parameters(self):
        """Test that pagination parameters are handled correctly for get_connection_history."""
        with patch.object(self.client, "session") as mock_session:
            mock_response = Mock()
            mock_response.status_code = 200
            mock_response.json.return_value = {
