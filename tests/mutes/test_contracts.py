...
"""
Auto-generated contract tests for {"class_name": "Mutes", "display_name": "mutes", "import_name": "mutes", "original": ["mutes"], "property_name": "mutes"} client.

This module contains tests that validate the request/response contracts
of the {"class_name": "Mutes", "display_name": "mutes", "import_name": "mutes", "original": ["mutes"], "property_name": "mutes"} client against the OpenAPI specification.
...
class TestMutesContracts:
    """Test the API contracts of MutesClient."""
    ...
    def test_unmute_user_request_structure(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            # Call the method
            try:
                method = getattr(self.mutes_client, "unmute_user")
