...
"""
Auto-generated pagination tests for {"class_name": "Chats", "display_name": "chats", "import_name": "chats", "original": ["chats"], "property_name": "chats"} client.
...
class TestChatsPagination:
    """Test pagination functionality for ChatsClient."""
    ...
    def test_get_chat_conversations_cursor_creation(self):
        """Test that get_chat_conversations can be used with Cursor."""
        ...
        try:
            ...
            pytest.fail(f"Method get_chat_conversations should support pagination")


    def test_get_chat_conversations_cursor_pages(self):
        """Test pagination with pages() for get_chat_conversations."""
    ...
    def test_get_chat_conversations_cursor_items(self):
        """Test pagination with items() for get_chat_conversations."""
        with patch.object(self.client, "session") as mock_session:
    ...
    def test_get_chat_conversations_pagination_parameters(self):
        """Test that pagination parameters are handled correctly for get_chat_conversations."""
        with patch.object(self.client, "session") as mock_session:
            mock_response = Mock()
            mock_response.status_code = 200
            mock_response.json.return_value = {
    ...
    def test_get_chat_conversation_events_cursor_creation(self):
        """Test that get_chat_conversation_events can be used with Cursor."""
        ...
        try:
            ...
            pytest.fail(
                f"Method get_chat_conversation_events should support pagination"
            )


    def test_get_chat_conversation_events_cursor_pages(self):
        """Test pagination with pages() for get_chat_conversation_events."""
        with patch.object(self.client, "session") as mock_session:
            # Mock first page response
            first_page_response = Mock()
            first_page_response.status_code = 200
    ...
    def test_get_chat_conversation_events_cursor_items(self):
        """Test pagination with items() for get_chat_conversation_events."""
        with patch.object(self.client, "session") as mock_session:
            # Mock response with paginated data
            mock_response = Mock()
            mock_response.status_code = 200
    ...
    def test_get_chat_conversation_events_pagination_parameters(self):
        """Test that pagination parameters are handled correctly for get_chat_conversation_events."""
        with patch.object(self.client, "session") as mock_session:
            mock_response = Mock()
            mock_response.status_code = 200
            mock_response.json.return_value = {
