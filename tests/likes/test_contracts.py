...
"""
Auto-generated contract tests for {"class_name": "Likes", "display_name": "likes", "import_name": "likes", "original": ["likes"], "property_name": "likes"} client.

This module contains tests that validate the request/response contracts
of the {"class_name": "Likes", "display_name": "likes", "import_name": "likes", "original": ["likes"], "property_name": "likes"} client against the OpenAPI specification.
...
class TestLikesContracts:
    ...
    def test_unlike_post_request_structure(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            # Call the method
            try:
                method = getattr(self.likes_client, "unlike_post")
    ...
    def test_like_post_request_structure(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            from xdk.likes.models import LikePostRequest
            ...
            # Call the method
            try:
                method = getattr(self.likes_client, "like_post")
                # Check if this is a true streaming operation (has stream_config parameter)
                import types
                import inspect
                sig = inspect.signature(method)
    ...
    def test_get_posts_liking_users_request_structure(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            # Call the method
            try:
                method = getattr(self.likes_client, "get_posts_liking_users")
                # Check if this is a true streaming operation (has stream_config parameter)
                import types
                import inspect
                sig = inspect.signature(method)
