...
"""
Auto-generated pagination tests for {"class_name": "Likes", "display_name": "likes", "import_name": "likes", "original": ["likes"], "property_name": "likes"} client.
...
class TestLikesPagination:
    ...
    def test_get_posts_liking_users_cursor_creation(self):
        ...
        try:
            ...
            pytest.fail(f"Method get_posts_liking_users should support pagination")
