    ...
    def test_create_conversation_request_structure(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            for (
                field_name,
                field_info,
            ) in CreateConversationRequest.model_fields.items():
            ...
            kwargs["body"] = CreateConversationRequest(**required_kwargs)
            # Call the method
            try:
    ...
    def test_create_by_conversation_id_request_structure(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            for (
                field_name,
                field_info,
            ) in CreateByConversationIdRequest.model_fields.items():
                if field_info.is_required():
                    annotation = (
                        str(field_info.annotation) if field_info.annotation else "str"
                    )
                    if "int" in annotation.lower():
                        ...
                        required_kwargs[field_name] = "test_value"
            kwargs["body"] = CreateByConversationIdRequest(**required_kwargs)
            # Call the method
            try:
                method = getattr(
    ...
    def test_create_by_participant_id_request_structure(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            for (
                field_name,
                field_info,
            ) in CreateByParticipantIdRequest.model_fields.items():
                if field_info.is_required():
                    annotation = (
                        str(field_info.annotation) if field_info.annotation else "str"
                    )
                    if "int" in annotation.lower():
                        ...
                        required_kwargs[field_name] = "test_value"
            kwargs["body"] = CreateByParticipantIdRequest(**required_kwargs)
            # Call the method
            try:
                method = getattr(
