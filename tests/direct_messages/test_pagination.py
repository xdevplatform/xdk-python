...
class TestDirectMessagesPagination:
    """Test pagination functionality for DirectMessagesClient."""
    ...
    def test_get_events_by_participant_id_cursor_pages(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            first_page_response.json.return_value = {
                "data": json.loads(
                    r"""[{"event_type":"test_value","id":"test_value"}, {"event_type":"test_value","id":"test_value"}]"""
                ),
                "meta": {
                    **json.loads(r"""{}"""),
            ...
            second_page_response.json.return_value = {
                "data": json.loads(
                    r"""[{"event_type":"test_value","id":"test_value"}]"""
                ),
    ...
    def test_get_events_by_participant_id_cursor_items(self):
        ...
        with patch.object(self.client, "session") as mock_session:
            ...
            mock_response.json.return_value = {
                "data": json.loads(
                    r"""[{"event_type":"test_value","id":"test_value"}, {"event_type":"test_value","id":"test_value"}, {"event_type":"test_value","id":"test_value"}]"""
                ),
