...
class TestDirectMessagesStructure:
    ...
    def test_unblock_users_dms_exists(self):
        ...
        # Check method exists
        method = getattr(DirectMessagesClient, "unblock_users_dms", None)
        assert (
            method is not None
        ), f"Method unblock_users_dms does not exist on DirectMessagesClient"
        # Check method is callable
    ...
    def test_unblock_users_dms_return_annotation(self):
        ...
        method = getattr(DirectMessagesClient, "unblock_users_dms")
        sig = inspect.signature(method)
        # Check return annotation exists
        assert (
            sig.return_annotation is not inspect.Signature.empty
    ...
    def test_block_users_dms_exists(self):
        ...
        # Check method exists
        method = getattr(DirectMessagesClient, "block_users_dms", None)
        assert (
            method is not None
        ), f"Method block_users_dms does not exist on DirectMessagesClient"
        # Check method is callable
    ...
    def test_block_users_dms_return_annotation(self):
        ...
        method = getattr(DirectMessagesClient, "block_users_dms")
        sig = inspect.signature(method)
        # Check return annotation exists
        assert (
            sig.return_annotation is not inspect.Signature.empty
