...
class DirectMessagesClient:
    ...
    def create_by_participant_id(
        ...
        body: Optional[CreateByParticipantIdRequest] = None,
    ) -> CreateByParticipantIdResponse:
        """
    ...
    def get_events_by_participant_id(
        ...
        event_types: Optional[
            List[Literal["MessageCreate", "ParticipantsJoin", "ParticipantsLeave"]]
        ] = None,
        dm_event_fields: Optional[
            List[
                Literal[
                    "attachments",
                    "created_at",
    ...
    def delete_events(self, event_id: schemas.DmEventId) -> DeleteEventsResponse:
        """
        Delete DM event
    ...
    def dm_conversations_media_download(
        self,
        dm_id: schemas.DmEventId,
        media_id: schemas.MediaId,
        resource_id: schemas.DmResourceId,
    ) -> bytes:
        """
        Download DM Media
        ...
        Args:
            dm_id: The unique identifier of the Direct Message event containing the media.
            media_id: The unique identifier of the media attached to the Direct Message.
            resource_id: The resource identifier of the media file, including file extension (e.g. 'hVJQTwig.jpg').
            Returns:
        ...
        url = url.replace("{dm_id}", str(dm_id))
