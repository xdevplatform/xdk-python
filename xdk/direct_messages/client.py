...
class DirectMessagesClient:
    ...
    def create_by_conversation_id(
        ...
        Args:
            ...
            body: At least one of `text`, `attachments` is required.
        Returns:
    ...
    def unblock_users_dms(self, id: schemas.UserId) -> UnblockUsersDmsResponse:
        """
        Unblock Users Dms
        Args:
            id: id
    ...
    def delete_events(self, event_id: str) -> DeleteEventsResponse:
        """
        Delete DM event
    ...
    def block_users_dms(self, id: schemas.UserId) -> BlockUsersDmsResponse:
        """
        Block Users Dms
        Args:
            id: id
    ...
    def dm_conversations_media_download(
        self, dm_id: str, media_id: str, resource_id: str
    ) -> bytes:
        """
        Download DM Media
