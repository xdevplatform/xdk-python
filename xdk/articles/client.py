...
"""
Auto-generated articles client for the X API.
...
class ArticlesClient:
    ...
    def article_create_draft(
        self, body: ArticleCreateDraftRequest
    ) -> ArticleCreateDraftResponse:
        """
        ...
        body: Request body
        Returns:
            ArticleCreateDraftResponse: Response data
        """
        url = self.client.base_url + "/2/articles/draft"
        ...
        return ArticleCreateDraftResponse.model_validate(response_data)


    def article_publish(self, article_id: str) -> ArticlePublishResponse:
        """
        Publish Article
        ...
        """
        url = self.client.base_url + "/2/articles/{article_id}/publish"
        url = url.replace("{article_id}", str(article_id))
        # OAuth2UserToken: Use access_token as bearer token (matches TypeScript behavior)
        # Priority: access_token > oauth2_session (for token refresh support)
        if self.client.access_token:
            # Use access_token directly as bearer token (matches TypeScript)
        ...
        response_data = response.json()
        # Convert to Pydantic model if applicable
        return ArticlePublishResponse.model_validate(response_data)
