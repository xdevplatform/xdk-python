...
"""
Auto-generated bookmarks client for the X API.
...
class BookmarksClient:
    ...
    def create_users_bookmark_folder(
        self, id: schemas.UserId, body: CreateUsersBookmarkFolderRequest
    ) -> CreateUsersBookmarkFolderResponse:
        """
        ...
        Args:
            ...
            body: Request body
        Returns:
            CreateUsersBookmarkFolderResponse: Response data
        """
        ...
        response_data = response.json()
        # Convert to Pydantic model if applicable
        return CreateUsersBookmarkFolderResponse.model_validate(response_data)
