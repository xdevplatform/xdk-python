...
class WebhooksClient:
    ...
    def get(
        self,
        webhook_config_fields: Optional[
            List[Literal["created_at", "id", "url", "valid"]]
        ] = None,
    ) -> GetResponse:
        """
        Get webhook
    ...
    def create_webhook_replay_job(
        self, body: CreateWebhookReplayJobRequest
    ) -> CreateWebhookReplayJobResponse:
        """
    ...
    def validate(self, webhook_id: str) -> ValidateResponse:
        """
        Validate webhook
    ...
    def create_stream_link(self, webhook_id: str) -> CreateStreamLinkResponse:
        """
        Create stream link
    ...
    def delete_stream_link(self, webhook_id: str) -> DeleteStreamLinkResponse:
        """
        Delete stream link
