...
"""
Auto-generated counts client for the X API.

This module provides a client for interacting with the counts endpoints of the X API.
...
from .models import (
    GetPostsRecentResponse,
    GetPostsAllResponse,
)


class CountsClient:
    """Client for counts operations"""
    ...
    def get_posts_recent(
    ...
    ) -> Iterator[GetPostsRecentResponse]:
        """
        ...
        Args:
            ...
            Yields:
            GetPostsRecentResponse: One page of results at a time. Automatically handles pagination using next_token.
        Note:
        ...
        while True:
            ...
            page_response = GetPostsRecentResponse.model_validate(response_data)
            # Yield this page
            yield page_response
    ...
    def get_posts_all(
        ...
        Args:
            ...
            search_count_fields: search_count.fields
            Yields:
            GetPostsAllResponse: One page of results at a time. Automatically handles pagination using next_token.
        Note:
            This method automatically paginates through all results. To get just the first page,
            you can call it once and break, or use the pagination_token parameter to start at a specific page.
        """
        ...
        while True:
            ...
            response_data = response.json()
            # Convert to Pydantic model if applicable
            page_response = GetPostsAllResponse.model_validate(response_data)
            # Yield this page
            yield page_response
            # Extract next_token from response
            next_token = None
