...
class UsersClient:
    ...
    def get_muting(
        ...
        pagination_token: Optional[schemas.PaginationTokenLong] = None,
    ...
    def get_bookmarks_by_folder_id(
        self,
        id: schemas.UserIdMatchesAuthenticatedUser,
        folder_id: schemas.BookmarkFolderId,
    ) -> GetBookmarksByFolderIdResponse:
        """
    ...
    def get_liked_posts(
        ...
        id: schemas.UserId,
        max_results: Optional[int] = None,
        pagination_token: Optional[schemas.PaginationToken36] = None,
        tweet_fields: Optional[
            List[
                Literal[
                    "article",
    ...
    def get_posts(
        self,
        id: schemas.UserId,
        since_id: Optional[schemas.TweetId] = None,
        until_id: Optional[schemas.TweetId] = None,
        max_results: Optional[int] = None,
        pagination_token: Optional[schemas.PaginationToken36] = None,
    ...
    def unfollow_list(
        self, id: schemas.UserIdMatchesAuthenticatedUser, list_id: schemas.ListId
    ) -> UnfollowListResponse:
        """
        Unfollow List
    ...
    def search(
        ...
        max_results: Optional[int] = None,
        next_token: Optional[schemas.PaginationToken36] = None,
        user_fields: Optional[
            List[
                Literal[
                    "affiliation",
    ...
    def unlike_post(
        self, id: schemas.UserIdMatchesAuthenticatedUser, tweet_id: schemas.TweetId
    ) -> UnlikePostResponse:
        """
        Unlike Post
    ...
    def pin_list(
        self, id: schemas.UserIdMatchesAuthenticatedUser, body: PinListRequest
    ) -> PinListResponse:
        """
        Pin List
    ...
    def create_bookmark(
        self, id: schemas.UserIdMatchesAuthenticatedUser, body: CreateBookmarkRequest
    ) -> CreateBookmarkResponse:
        """
        Create Bookmark
