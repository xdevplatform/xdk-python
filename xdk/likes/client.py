...
"""
Auto-generated likes client for the X API.
...
class LikesClient:
    ...
    def get_posts_liking_users(
    ...
    ) -> Iterator[GetPostsLikingUsersResponse]:
        """
        ...
        Args:
            ...
            Yields:
            GetPostsLikingUsersResponse: One page of results at a time. Automatically handles pagination using next_token.
        Note:
        ...
        while True:
            ...
            response_data = response.json()
            # Convert to Pydantic model if applicable
            page_response = GetPostsLikingUsersResponse.model_validate(response_data)
            # Yield this page
            yield page_response
